        ...
        <div class="row">
            ...
            <div class="col-md-4  animate fadeInUp" data-wow-delay="0.4s">
                ...
                <div class="product-slides">
                    ...
                    <div class="items-in">
                        <!-- Image -->
                        <img src="{{ asset('assets/sebian/') }}/images/item-img-1.jpg" alt="">
                        <!-- Hover Details -->
                        <div class="over-item">
                    ...
                    <div class="items-in">
                        <!-- Image -->
                        <img src="{{ asset('assets/sebian/') }}/images/item-img-2.jpg" alt="">
                        <!-- Hover Details -->
                        <div class="over-item">
                            <ul class="animated fadeIn">
                    ...
                    <div class="items-in">
                        <!-- Image -->
                        <img src="{{ asset('assets/sebian/') }}/images/item-img-3.jpg" alt="">
                        <!-- Hover Details -->
                        <div class="over-item">
                            <ul class="animated fadeIn">
...
<section class="section-p-30px add_block_2">
    <div class="container">
        <ul class="row">
            <li class="col-sm-6 animate fadeInLeft" data-wow-delay="0.4s"> <a href="#."><img src="{{ asset('assets/sebian/') }}/images/add_block_1.jpg" alt=""></a> </li>
            <li class="col-sm-6 animate fadeInRight" data-wow-delay="0.4s"> <a href="#."><img src="{{ asset('assets/sebian/') }}/images/add_block_2.jpg" alt=""></a> </li>
        </ul>
    </div>
</section>
...
<footer>
    <div class="container">
        <div class="text-center"> <a href="#."><img src="{{ asset('assets/sebian/') }}/images/logo.png" alt=""></a><br>
            <img class="margin-t-40" src="{{ asset('assets/sebian/') }}/images/hammer.png" alt="">
